...
mysql_query("DELETE FROM `$CATALOGIPLIST`");							# clear the CATALOGiplist

$result = mysql_query("SELECT * FROM $CATALOGNETBLOCKS");				#grab all the netblock data
...
mysql_query("INSERT INTO $CATALOGIPLIST (`IP`) VALUES ('$IP')");			# insert the value into CATALOGiplist
...
$result = mysql_query("SELECT * FROM $CATALOGEXCLUDEIP");			# grab all the data from CATALOGexcludeip
...
$delete = mysql_query("DELETE FROM `$CATALOGIPLIST` WHERE `ip` = '$excludedIP' ");	# delete the excluded IP from CATALOGiplist

}	# end the while loop grabbing data from the EXCLUDE IP list


$result = mysql_query("SELECT * FROM $CATALOGINCLUDEIP");			# grab all the data from CATALOGincludeip
...
$insert = mysql_query("INSERT INTO `$CATALOGIPLIST` (`ip`) VALUES ('$IP') ");	# insert the included IP from CATALOGiplist
